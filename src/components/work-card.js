            ...
            <div className=' w-full  text-lk-red-600 text-center   '>
                ...
                <div
                    ...
                    <h3
                        ...
                        md:text-end	md:text-[7rem] lg:text-[11rem] lg:mt-auto'>
                        {projectInfo.title}
                    </h3>

                    {/* TAG TEXT */}
                    <div className='  h-full flex self-start md:self-end'>
                ...
                <div className="flex flex-nowrap gap-7 h-auto md:h-[450px] lg:h-[594px]">
                    {/* DESKTOP */}
                    <div className={`px-3 py-6 overflow-hidden md:p-2 flex ${projectInfo.imgBgColor} lg:w-full justify-center items-center`}>
                        <img
                    ...
                    {/* MOBILE */}
                    <div className={`hidden md:p-2 md:flex ${projectInfo.imgBgColor} lg:w-[392px] justify-center items-center`}>
                        <img
