...
export const metadata = {
  ...
  openGraph: {
    images:
      "https://i.pinimg.com/736x/74/0c/ba/740cba360d5925d14acf4e1b2ce5bfa1.jpg",
  },
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" data-overlayscrollbars-initialize>
      ...
      <body
        className={`${poppins.variable} ${noto.variable} ${crimson.variable} ${haetten.variable} bg-lk-grey`}
      >
        {children}
      </body>
    </html>
